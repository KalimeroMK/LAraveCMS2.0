...
class CategoryController extends Controller {
	...
	public function delete($id) {
		...
		if (!is_null($id) && sizeof(Categories::where('id', $id)->get()) > 0) {
			...
			$sub_pluck = SubCategories::where('parent_id', $id)->pluck('id');

			if (sizeof($sub_pluck) > 0) {
				Sources::whereIn('category_id', $sub_pluck)->delete();
				Posts::whereIn('category_id', $sub_pluck)->delete();
